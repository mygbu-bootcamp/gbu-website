...
const Primarynavbar = () => {
  ...
  return (
    <nav className="bg-gradient-to-r from-green-600 via-teal-600 to-blue-700 text-white text-sm relative">
          ...
          <div className="mt-12 space-y-6 text-sm font-medium">
            ...
            <div>
              ...
              <div className="space-y-2">
                <a href="https://tender-navigator-portal.vercel.app/" className="block px-3 py-2 rounded-md hover:bg-gray-100">Tenders</a>
                <a href="https://recruit-hub-display.lovable.app/" className="block px-3 py-2 rounded-md hover:bg-gray-100">Recruitments</a>
                <a href="https://gbu-facility-bookings-39.lovable.app/" className="block px-3 py-2 rounded-md hover:bg-gray-100">Booking</a>
                <a href="https://rti-page-rebuild-50.lovable.app/" className="block px-3 py-2 rounded-md hover:bg-gray-100">RTI</a>
                <a href="#" className="block px-3 py-2 rounded-md hover:bg-gray-100">Sitemap</a>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-2">
                <a href="https://preview--fee-wise-campus-pay.lovable.app/" className="block px-3 py-2 rounded-md hover:bg-gray-100">Online Fee Payment</a>
                <a href="https://uni-spark-dashboard.lovable.app/" className="block px-3 py-2 rounded-md hover:bg-gray-100">Student Portal</a>
                <a href="https://mygbu-faculty-nexus-3d.lovable.app/" className="block px-3 py-2 rounded-md hover:bg-gray-100">Employee Login</a>
                <a href="https://buddha-directory-glide-28.lovable.app" className="block px-3 py-2 rounded-md hover:bg-gray-100">Directory</a>
                <a href="http://gbu-contact-hub-banner.vercel.app" className="block px-3 py-2 rounded-md hover:bg-gray-100">Contact Us</a>
              </div>
            </div>
          </div>
        </div>
