...
export const Input = React.forwardRef(({ className = '', ...props }, ref) => (
  <input
    ref={ref}
    className={`block w-full rounded border border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-100 py-2 px-3 text-gray-900 placeholder-gray-400 outline-none transition-all duration-150 ${className}`}
    {...props}
  />
));
