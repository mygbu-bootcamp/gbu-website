...
const Card = ({ children, className = '', ...props }) => (
  <div
    className={`bg-white rounded-xl shadow border border-gray-100 transition hover:shadow-md ${className}`}
    {...props}
  >
    {children}
  </div>
...
const CardTitle = ({ children, className = '', ...props }) => (
  <h3 className={`font-semibold text-lg tracking-tight ${className}`} {...props}>
    {children}
  </h3>
);
