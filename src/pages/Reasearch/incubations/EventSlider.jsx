 ...
 const events = [
  {
    ...
    images: [
      "https://www.gburif.org/event/students.jpeg"
    ],
  ...
  },
  {
    ...
    images: [
      "https://www.gburif.org/event/innovation.jpeg"
    ],
  ...
  },
  {
    ...
    images: [
      "https://www.gburif.org/event/women-tech.jpeg"
    ],
  ...
  },
  {
    ...
    images: [
      "https://www.gburif.org/event/robotics.jpeg"
    ],
  ...
  },
  {
    ...
    images: [
      "https://www.gburif.org/event/hackathon.jpeg"
    ],
  ...
  },
  {
    ...
    images: [
      "https://www.gburif.org/event/startup.jpeg"
    ],
    ...
    <div className="max-w-7xl mx-auto px-4 py-12">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
        {filteredEvents.map((event, idx) => (
          <div
            ...
            className="bg-white rounded-2xl shadow-md border border-gray-100 cursor-pointer hover:shadow-lg transition overflow-hidden"
          >
            <img
              src={event.image}
              alt={event.title}
      ...
      <AnimatePresence>
        {selectedEvent && (
          ...
          >
            <motion.div
              className="bg-white max-w-3xl w-full rounded-xl overflow-hidden relative shadow-xl"
              initial={{ scale: 0.8 }}
              animate={{ scale: 1 }}
              exit={{ scale: 0.8 }}
