...
//           className="text-lg"
//         >
//           Explore vibrant moments from university events. Click any photo for details!
//         </motion.p>
...
//             <motion.div layout className="grid grid-cols-1 sm:grid-cols-1 lg:mx-50 md:mx-20 sm:mx-5 md:grid-cols-2 lg:grid-cols-3 gap-6">
//               <AnimatePresence>
...
//                     className="group bg-white rounded-lg overflow-hidden shadow hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300"
//                   >
//                     <div
//                       className="bg-white rounded-xl shadow border border-gray-100 border-solid overflow-hidden hover:shadow-lg transition-all duration-300"
//                       style={{ height: '26rem' }}
//                     >
//                       <div
//                         className="h-[70%] cursor-pointer overflow-hidden"
