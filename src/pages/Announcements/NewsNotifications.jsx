    ...
    <div className="min-h-screen w-full bg-gradient-to-br from-blue-50 via-white to-blue-100">
      ...
      <div className=" w-full pb-5">
        ...
        <motion.div
          ...
          initial="hidden"
          animate="visible"
          className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 lg:mx-40 md:mx-20 sm:mx-10 gap-8"
        >
          <AnimatePresence>
            {currentNews.map((news) => (
              <motion.div key={news.id} variants={item} whileHover={{ scale: 1.02 }}>
