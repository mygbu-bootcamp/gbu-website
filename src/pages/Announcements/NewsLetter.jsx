...
const mockNewsletters = [
  {
    ...
    date: "2024-03-15",
    coverImage: "https://images.unsplash.com/photo-1571260899304-425eee4c7efc?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80",
    excerpt: "Highlights from Spring 2024 at GBU: new research centers inaugurated, cultural fests, and student achievements.",
  },
  {
    id: 2,
    ...
    date: "2023-12-10",
    coverImage: "https://images.unsplash.com/photo-1618886614635-3f5c2fbb25ff?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80",
    excerpt: "GBU’s Winter 2023: Convocation ceremony, faculty accolades, and campus beautification drives.",
  },
  {
    id: 3,
    ...
    date: "2023-09-20",
    coverImage: "https://images.unsplash.com/photo-1608138274420-95f5e4172780?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80",
    excerpt: "Autumn insights: Research symposiums, guest lectures, and sustainability initiatives at GBU.",
  },
  {
    id: 4,
    ...
    date: "2023-06-18",
    coverImage: "https://images.unsplash.com/photo-1603484477859-abe38b4032e3?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80",
    excerpt: "Summer 2023: Internships, workshops, and global exchange programs keeping GBU buzzing.",
  },
  {
    id: 5,
    ...
    date: "2023-03-12",
    coverImage: "https://images.unsplash.com/photo-1596495577886-2a64c0765903?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80",
    excerpt: "Spring moments: Campus life, inter-college fests, and student start-up showcases at GBU.",
  },
  {
    id: 6,
    ...
    date: "2022-12-08",
    coverImage: "https://images.unsplash.com/photo-1602524207337-73f38f3f2a4e?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80",
    excerpt: "Winter wrap-up: Year-end celebrations, alumni success stories, and campus developments.",
  },
  {
    id: 7,
    ...
    date: "2022-09-22",
    coverImage: "https://images.unsplash.com/photo-1562774053-701939374585?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80",
    excerpt: "Autumn activities: New research collaborations, campus placements, and cultural fests.",
  },
  {
    id: 8,
    ...
    date: "2022-06-15",
    coverImage: "https://images.unsplash.com/photo-1599742454034-52b21965b1b3?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80",
    excerpt: "Summer insights: Skill enhancement programs, summer schools, and student achievements.",
  },
  {
    id: 9,
    ...
    date: "2022-03-10",
    coverImage: "https://images.unsplash.com/photo-1599957788407-0189f50baf0e?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80",
    excerpt: "Spring 2022: Academic conferences, student club activities, and infrastructure growth at GBU.",
  },
  {
    id: 10,
    ...
    date: "2021-12-05",
    coverImage: "https://images.unsplash.com/photo-1603392256233-27c49007b98f?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80",
    excerpt: "Winter 2021: Highlights of the year, convocation glimpses, and new courses launched at GBU.",
  },
];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3  gap-10 mx-10">
          {currentNewsletters.map((newsletter) => (
            <Card key={newsletter.id} className="relative h-[45rem] group">
              ...
              <div className="aspect-[2/4] w-full h-3/6  overflow-hidden rounded-t-3xl bg-gradient-to-br from-blue-100/60 to-blue-200/30">
                <img
