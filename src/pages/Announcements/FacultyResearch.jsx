...
const FacultyResearch = () => {
  ...
  const handleArchive = (paper, faculty) => {
    ...
    <div className="min-h-screen bg-gradient-to-br from-rose-50 via-sky-50 to-lime-50 py-12 px-6">
      ...
      <div className="flex justify-center mb-8 space-x-4">
        <button
          ...
          className={`px-4 py-2 rounded-full text-sm font-semibold shadow transition ${activeTab === 'Active'
        ...
        <button
          ...
          className={`px-4 py-2 rounded-full text-sm font-semibold shadow transition ${activeTab === 'Archived'
