...
const Card = ({ className = "", children, ...props }) => (
  <div
    className={`rounded-2xl bg-white shadow-lg border border-blue-100 ${className}`}
    {...props}
  >
    {children}
  </div>
...
const CardDescription = ({ className = "", children, ...props }) => (
  <p className={`text-muted-foreground text-base mb-2 ${className}`} {...props}>
    {children}
  </p>
);
...
const Button = ({
  ...
  const base =
    "inline-flex items-center justify-center font-semibold rounded-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-400";
  const variants = {
    default:
      "bg-gradient-to-r from-blue-600 to-indigo-600 text-white hover:from-blue-700 hover:to-indigo-700 shadow-md",
    outline:
      "bg-white border border-blue-300 text-blue-700 hover:bg-blue-50 shadow-sm",
  };
  const sizes = {
