            ...
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 p-6">
                {dept.members.map((member, memberIndex) => (
                  <div
                    key={memberIndex}
                    className="bg-gradient-to-r from-gray-50 to-blue-50 rounded-2xl p-6 border-l-4 border-blue-300 hover:border-blue-500 transition-all duration-300 hover:shadow-md shadow-xl hover:shadow-2xl transform hover:-translate-y-2 flex flex-col"
                    style={{
