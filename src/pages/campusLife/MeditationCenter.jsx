...
const MeditationCenter = () => {
          ...
          {statistics.map((stat, index) => (
            ...
            >
              <div className="text-center">
                <div
                  className="w-20 h-20 mx-auto mb-4 rounded-full flex items-center justify-center shadow-lg transform hover:scale-110 transition-transform duration-300"
  ...
  const VisionMissionSection = () => (
    <section
      id="about"
      className="py-24 bg-gradient-to-br from-blue-50 via-white to-purple-100"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div
          className={`transition-all duration-1000 ease-out ${
